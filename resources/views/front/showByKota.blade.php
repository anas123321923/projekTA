...
@section('description')
  Manokwari Kost, cari kos di Kota Manokwari makin mudah hanya di Manokwari Kost. aplikasi pencari kos di indonesia.
@endsection
@section('title')
...
@section('content')
  ...
  <div class="mb-2" style="font-weight: bold">
    @if ($kota == 'MANOKWARI BARAT')
        Kost Manokwari Barat
    @elseif($kota == 'MANOKWARI TIMUR')
        Kost Manokwari Timur
    @elseif($kota == 'MANOKWARI UTARA')
        Kost Manokwari Utara
    @elseif($kota == 'MANOKWARI SELATAN')
        Kost Manokwari Selatan
    @elseif($kota == 'MASNI')
        Kost Masni
    @elseif($kota == 'PRAFI')
        Kost Prafi
        ...
        <div class="card-content">
          ...
          <div class="card-body">
            <a href="{{url('room', $kamars->slug)}}">
              ...
              <p class="card-text mt-1 mb-0"><i class="feather icon-map-pin"></i> Manokwari, Papua Barat</p>
